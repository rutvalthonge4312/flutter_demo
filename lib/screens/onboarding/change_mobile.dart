...
import 'package:wrms.app/screens/onboarding/widgets/change_mobile_form.dart';
import 'package:wrms.app/widgets/index.dart';

class ChangeMobileScreen extends StatelessWidget {
  const ChangeMobileScreen({Key? key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(title: 'Change Mobile'),
            ...
            builder: (context, AsyncSnapshot<void> snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                if (authModel.isAuthenticated) {
                  return ChangeMobile(userModel: Provider.of<UserModel>(context));
                } else {
